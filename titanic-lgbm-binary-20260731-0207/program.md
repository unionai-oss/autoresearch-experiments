...
Tier A: LightGBM with optuna hyperparameter tuning (num_leaves, learning_rate, min_child_samples, feature_fraction). With only 891 samples and 11 mixed-type features, this is a classic small tabular dataset squarely in Tier A; LightGBM handles the moderate class imbalance (549/342) and mixed numeric/categorical features efficiently without needing deep models that would overfit at this scale. Start here directly in experiment 0 — do not begin at a simpler tier.
